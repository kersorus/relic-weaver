...
- локальный save в `user://relic_weaver_save.json` с проверенной записью и резервной копией;
...
- отдельные настройки громкости, reduced motion, встряски, вибрации и скорости боя;
- автоматическая пауза боя после сворачивания игры или потери фокуса;
- полностью офлайн, без рекламы, серверов, аккаунтов и SDK аналитики;
- portrait UI под 720×1280, мышь и touch;
- анимированные линии активных связей с отдельными формами-маркерами, не зависящими только от цвета;
...
Если запушить тег вроде `v1.1.1`, workflow дополнительно создаст GitHub Release и приложит к нему бинарники и checksums. Данные игры встроены в desktop-бинарники: отдельный `.pck` скачивать не нужно.
