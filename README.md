...
- GitHub Actions проверяет загрузку, полный игровой маршрут и собирает Android APK, Linux x86_64 и Windows x86_64.
...
Если запушить тег вроде `v1.0.0`, workflow дополнительно создаст GitHub Release и приложит к нему бинарники и checksums.
