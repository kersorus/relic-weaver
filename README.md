...
- завершённая кампания из 5 сюжетных глав по 5 боёв с двумя финальными рубежами;
- 13 типов противников, промежуточные хранители и два сюжетных босса;
- 15 оригинальных предметов;
...
- цельная пиксельная арт-дирекция: 15 предметов, 14 персонажей, 12 props/UI-иконок и 5 детализированных вертикальных окружений;
...
Если запушить тег вроде `v1.2.0`, workflow дополнительно создаст GitHub Release и приложит к нему бинарники и checksums. Данные игры встроены в desktop-бинарники: отдельный `.pck` скачивать не нужно.
